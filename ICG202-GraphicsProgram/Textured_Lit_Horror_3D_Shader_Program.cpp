...
Textured_Lit_Horror_3D_Shader_Program::Textured_Lit_Horror_3D_Shader_Program(const Shader* vertex_shader, const Shader* fragment_shader)
	: Shader_Program(vertex_shader, fragment_shader)
{
}

Textured_Lit_Horror_3D_Shader_Program::~Textured_Lit_Horror_3D_Shader_Program()
{
}

void Textured_Lit_Horror_3D_Shader_Program::render(const Mesh* mesh, const Texture* texture, const glm::mat4* transformation) const
{
